...
def build_plotly_preview(pallet: Pallet, placements: List[Placement], title: str) -> go.Figure:
    ...
    fig.add_annotation(x=pallet.base_length / 2, y=pallet.max_depth_per_side + pallet.center_depth / 2, text='Center Frame', showarrow=False, font=dict(size=16, color='black'))
    for p in placements:
